...
import { Mail, Loader2, Trash2, Reply, Clock, CheckCircle2, Filter } from 'lucide-react';
...
import { useGetAllMessages, useReplyToMessage, useDeleteMessage } from '../hooks/useQueries';
import { toast } from 'sonner';
import { StoredMessage, FormType } from '../backend';
...
export default function MessageManagement() {
  ...
  const filteredMessages = allMessages.filter((message) => {
    const matchesFormType = filterFormType === 'all' || message.formType === filterFormType;
              ...
              <div className="flex items-center gap-2">
                ...
                <Select value={filterFormType} onValueChange={setFilterFormType}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value={FormType.consultoria}>Consultoría</SelectItem>
          ...
          {filteredMessages.length === 0 ? (
            ...
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
                {filteredMessages.length} mensaje{filteredMessages.length !== 1 ? 's' : ''} encontrado
