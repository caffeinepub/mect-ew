...
import type { FormType, StoredMessage } from "../backend";
import {
  useDeleteMessage,
  useGetFormSpecificMessages,
  useReplyToMessage,
...
export default function FormSpecificMessageManagement({
  formType,
}: FormSpecificMessageManagementProps) {
  const { data: messages = [], isLoading } =
    useGetFormSpecificMessages(formType);
      ...
      <Dialog open={showReplyDialog} onOpenChange={setShowReplyDialog}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label
                htmlFor="reply-textarea-fsm"
                className="text-sm font-medium"
              >
                Tu respuesta:
              </label>
              <Textarea
                id="reply-textarea-fsm"
                value={replyText}
