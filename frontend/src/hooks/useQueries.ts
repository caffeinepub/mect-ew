  ...
  return useQuery<boolean>({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        console.log('Admin check result for principal', principalString, ':', result);
        return result;
      } catch (error) {
...
export function useUploadThumbnail() {
  ...
  return useMutation({
    mutationFn: async (params: {
      ...
      const thumbnailType = params.thumbnailType === 'manualUpload' 
        ? ThumbnailType.manualUpload 
        : ThumbnailType.autoGenerated;
      
      let imageFormat: Variant_jpg_png_webp;
      if (params.imageFormat === 'jpg') {
        imageFormat = Variant_jpg_png_webp.jpg;
      } else if (params.imageFormat === 'png') {
        imageFormat = Variant_jpg_png_webp.png;
      } else {
        imageFormat = Variant_jpg_png_webp.webp;
      }
